package com.hath_zhou.generator;
 ...
 *
 * @author HathZhou on 2021/5/7 20:55
 */
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername("hath_zhou");
        dsc.setPassword("0512");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.hath_zhou.seckill")
                .setEntity("pojo")
                .setMapper("mapper")
                .setService("service")
